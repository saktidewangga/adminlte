...
<head>
    ...
    <link rel="stylesheet" href="assets/css/kint.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <?= $this->renderSection('navbarRight') ?>
        </nav>
        <!-- /.navbar -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                <img src="assets/vendor/adminlte/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <div class="brand-text font-weight-light"><?= $data->site->name; ?></div>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <!-- <div class="image">
                        <img src="assets/vendor/adminlte/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                    </div> -->
                    <div class="info">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"><?= $data->page->title ?></h1>
                        </div>
                        <!-- <div class="col-sm-6">
